...
const HomePage = () => {
  return (
    <div className="min-h-screen bg-white">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div className="slide-left">
              ...
              <div className="flex gap-4 flex-wrap">
                <a
                  href="https://wa.me/919371306189?text=Hi%20Godavari%20Fish%2C%20I%20would%20like%20to%20know%20more%20about%20your%20products"
                  target="_blank"
      ...
      {/* Featured Highlights — animated counters */}
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
            ...
            <AnimatedStat value="24/7" label="WhatsApp Support" delay={450} />
          </div>
        </div>
      </section>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center z-10">
          <ScrollReveal>
            ...
            <p className="text-xl mb-8 text-blue-50/90">
              Contact us today on WhatsApp or call to place your order
            </p>
